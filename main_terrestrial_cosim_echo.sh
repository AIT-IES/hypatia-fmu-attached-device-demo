...
RUN_DIR=${DEMO_DIR}/demo_terrestrial_run_dir # 
...
cp -R ${DEMO_DIR}/src/main_terrestrial_cosim_echo/ ${HYPATIA_ROOT_DIR}/ns3-sat-sim/simulator/scratch

# Run the simulation
cd ${HYPATIA_ROOT_DIR}/ns3-sat-sim/simulator; 
./waf --run="main_terrestrial_cosim_echo --run_dir='${RUN_DIR}'" 2>&1 | tee ${LOG_DIR}/console.txt
